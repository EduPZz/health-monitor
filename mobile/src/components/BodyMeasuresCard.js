...
const BodyMeasuresCard = ({ measures, onPress, onAddNew }) => {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptySubtext}>
            Comece a acompanhar suas medidas
          </Text>
  ...
  const chestChange = getMeasureChange(
    latestMeasure.chest,
    previousMeasure?.chest
  );

  const waistChange = getMeasureChange(
    latestMeasure.waist,
    previousMeasure?.waist
  );
    ...
    <View style={styles.container}>
      ...
      <View style={styles.measuresGrid}>
        <View style={styles.measureItem}>
          ...
          <Text style={styles.measureValue}>{latestMeasure.chest || "N/A"} cm</Text>
          {chestChange && (
            <View style={styles.changeContainer}>
              ...
              <Text
                style={[
                  ...
                  {
                    color:
                      chestChange.direction === "up" ? "#F44336" : "#4CAF50",
                  },
                ]}
              >
                {chestChange.value}
        ...
        <View style={styles.measureItem}>
          ...
          <Text style={styles.measureValue}>{latestMeasure.waist || "N/A"} cm</Text>
          {waistChange && (
            <View style={styles.changeContainer}>
              <Icon.FontAwesome6
              ...
              <Text
                style={[
                  ...
                  {
                    color:
                      waistChange.direction === "up" ? "#F44336" : "#4CAF50",
                  },
                ]}
              >
                {waistChange.value}
        ...
        <View style={styles.measureItem}>
          ...
          <Text style={styles.measureValue}>{latestMeasure.arm || "N/A"} cm</Text>
        </View>
      ...
      <View style={styles.footer}>
        <Text style={styles.lastUpdate}>
          Última atualização: {formatDate(latestMeasure.createdAt)}
        </Text>

        <TouchableOpacity style={styles.viewAllButton} onPress={onPress}>
          <Text style={styles.viewAllText}>Ver todas as medidas</Text>
