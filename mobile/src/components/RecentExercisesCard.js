...
const RecentExercisesCard = ({ exercises, onPress, onAddNew }) => {
  ...
  function getDurationInMinutes(data) {
          ...
          <View key={exercise.id || index} style={styles.exerciseItem}>
            ...
            <View style={styles.exerciseInfo}>
              <Text style={styles.exerciseName}>
                {exercise.type || "Exercício não informado"}
              </Text>
              <View style={styles.dateContainer}>
                <Icon.FontAwesome6 name="calendar" size={10} color="#666" />
                <Text style={styles.dateText}>
                  {formatDate(exercise.beginTime)}
                </Text>
              </View>
            </View>

            <View style={styles.exerciseStats}>
              {getDurationInMinutes(exercise) && (
                <Text style={styles.statText}>
                  {getDurationInMinutes(exercise)} min
                </Text>
              )}
            </View>
          </View>
